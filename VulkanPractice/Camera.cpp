...
void Camera::cameraInit() {
    view = glm::lookAt(glm::vec3(0.0f, 20.0f, 10.0f), glm::vec3(0.0f, 30.0f, 10.0f), glm::vec3(0.0f, 0.0f, 1.0f));
...
void Camera::updateCamera() {
    ...
    totalCamT += delta;
    //view = glm::lookAt(glm::vec3(0.0f, 00.0f + 1.0f * totalCamT, 0.0f), glm::vec3(0.0f, 40.0f+ 1.0f * totalCamT, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    view = glm::rotate(view, delta*glm::radians(10.0f), glm::vec3(0.0f, 1.0f, 0.0f));
