...
set_and_check(MATERIALX_BASE_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}")
set_and_check(MATERIALX_STDLIB_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/libraries")
if(OFF AND ON)
    set_and_check(MATERIALX_PYTHON_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/python")
endif()
if(ON AND ON)
    set_and_check(MATERIALX_RESOURCES_DIR "${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/resources")
endif()
