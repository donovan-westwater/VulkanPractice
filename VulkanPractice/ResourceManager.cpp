...
void ResourceManager::initVulkan() {
    ...
    modelList[0].setPosition(glm::vec3(4, -4, -4));
    //modelList[0].setRotation(glm::vec3(0, glm::radians(90.0f), 0));
    Model test2;
    modelList.push_back(test2);
    modelList[1].loadModel("Models/dino.obj", MATERIALS_PATH, TEXTURES_PATH + "dino.png");;
    modelList[1].setScale(glm::vec3(.25f));
    modelList[1].setPosition(glm::vec3(-4, -4, -4));
